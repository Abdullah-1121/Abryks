...
const Featured = () => {
  ...
  return (
    ...
    <div className="featured-products py-8">
      <div className=' flex justify-between'><h2 className="text-2xl font-bold  mb-6 ml-4">Our Trending Products</h2><span className='mx-4 mt-3 text-blue-400 flex '>See All</span></div>
