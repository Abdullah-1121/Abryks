...
//      params:{slug:string}
// }){
//   const random = useMemo(() => Math.floor(Math.random() * (13 - 2)), []);
//   const random2 = useMemo(() => random + 4, [random]);
...
//     setRatings=getRandomRating()
    
//     // const memoizedRating = getMemoizedRating(product._id)
//     return (
